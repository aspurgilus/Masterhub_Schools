                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/schools" method="post">
                            ...
                            <div class="form-group row">
                                <label for="phone" class="col-md-4 col-form-label text-md-right">Введите номер телефона вашей школы<br><span class="hint">(опционально)</span></label>
                            ...
                            <div class="form-group row">
                                <label class="col-form-label ml-md-5 border">Выберите специализацию вашей школы<br><span class="hint">(можно выбрать несколько значений)</span><br>

                                <label class="m-3">Косметология: <input type="checkbox" name="cosmetology"></label>
                                <label class="m-3">Маникюр: <input type="checkbox" name="manicure"></label>
                                <label class="m-3">Педикюр: <input type="checkbox" name="pedicure"></label>
                                <label class="m-3">Мейк-ап: <input type="checkbox" name="makeup"></label>
                                </label>
                            </div>
