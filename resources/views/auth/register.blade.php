...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Заполните форму регистрации</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        <div class="form-group row">
                            <select class="custom-select-lg" name="status" id="status" required>
                                <option selected disabled>Выберите тип аккаунта</option>
                                <option value="OwnerSchool">Владелец школы</option>
